...
\label{}
	...
	\begin{enumerate}
		...
		\item Elections for Executive and Council Positions
			\begin{enumerate}[i.]
				\item Members may be nominated for any of the following positions:
				\begin{enumerate}[a.]
					\item The Executive
					\item PhD Representative
					\item MCS Representative
					...
					\item Member-At-Large
				\end{enumerate}
				\item The executive voting ballot shall allow members to select between zero (0) and five (5) candidates for positions on the executive.  The five (5) candidates with the most votes shall form the executive.
				\item The general membership shall select five (5) nominees for a position on the executive.  The newly elected council will vote at its first meeting which members of the executive shall perform position within the executive (see Article \ref{dutiesCouncilMembers})
		...
		\item Dalhousie Computer Science In-House Conference (DCSI) Organizing Committee
			\begin{enumerate}[i.]
				\item 
			\end{enumerate}
